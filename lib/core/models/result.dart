...
/// Result class that handle the errores and result in one simple and powerful handler
///
/// Use [failRes] and [successRes] only if the previous validations was made.
/// With the function [when] easily you can handle the result and error and make custom logic.
/// If need make some validations about the data of the result use [isFail] or [isSuccess]
